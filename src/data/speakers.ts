...
export const guests: Speaker[] = [
  {
    ...
    bio: '中国科学技术大学教授，长期从事量子信息的理论与实验研究，主要方向涵盖量子光学、量子通信与量子计算。1965 年于中国科学技术大学无线电电子学系毕业并留校任教，1981—1983 年于加拿大多伦多大学访问学者，2003 年当选中国科学院院士（信息技术科学部）。',
    isGuest: true,
  },
  {
    id: 'lu-xiyun',
    ...
    title: '中国科学院院士',
    affiliation: '中国科学技术大学',
    bio: '中国科学技术大学教授，长江学者特聘教授。提出了物体受力的主控旋涡概念和有限域涡量矩理论；系统研究了游动和飞行的生物运动流体力学，发现了生物高性能推进的旋涡动力学规律；建立了高速流动中旋涡剪切和流体压缩耦合作用的分析方法。2019 年当选中国科学院院士。',
    isGuest: true,
  },
  {
    id: 'guo-guoping',
