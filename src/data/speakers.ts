...
export const guests: Speaker[] = [
  {
    ...
    bio: '中国科学院院士，中国科学技术大学教授。我国量子光学与量子信息领域的开拓者之一，长期致力于量子光学、量子信息与量子通信研究。',
    isGuest: true,
  },
  {
    id: 'lu-xiyun',
    ...
    title: '中国科学院院士',
    affiliation: '中国科学技术大学',
    bio: '中国科学院院士，中国科学技术大学教授。在湍流、生物运动力学、流动稳定性与控制等方向取得系统性原创成果。',
    isGuest: true,
  },
  {
    id: 'guo-guoping',
    ...
    bio: '中国科学技术大学教授，本源量子首席科学家。长期从事半导体与超导量子计算研究，主导我国自主可控超导量子计算机研发。',
    isGuest: true,
  },
]
