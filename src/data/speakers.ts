 ...
 * 嘉宾与报告人数据
 * 出处：详见仓库根 SOURCES.md
 *  - guests 三人头衔来自二轮通知 docx；郭光灿、陆夕云的 bio 来自维基百科 + 百度百科
 *  - 郭国平：维基百科无独立词条，百度百科同名为另一位（武汉理工船舶教授），暂不附 bio
...
export const guests: Speaker[] = [
  {
    ...
    bio: '中国科学技术大学教授，我国量子光学与量子信息领域的开拓者之一。提出量子避错编码原理与概率量子克隆原理（"段-郭克隆机"）。2003 年当选中国科学院院士。',
    isGuest: true,
  },
  {
    id: 'lu-xiyun',
    ...
    title: '中国科学院院士',
    affiliation: '中国科学技术大学',
    bio: '中国科学技术大学教授，长江学者特聘教授。提出物体受力的主控旋涡概念与有限域涡量矩理论，在生物运动力学与高速可压缩流动方向取得系统性原创成果。2019 年当选中国科学院院士。',
    isGuest: true,
  },
  {
    id: 'guo-guoping',
    ...
    bio: '中国科学技术大学教授，第十四届全国人大代表，中国科学院量子信息重点实验室副主任，合肥国家实验室高级研究员（兼），安徽省量子芯片重点实验室主任，本源量子首席科学家。长期从事量子计算研究，是我国首台已交付用户超导量子计算机及国内首条量子芯片生产线研发团队主要负责人；获中国青年科技奖、国家杰出青年科学基金，曾任 973 项目首席科学家、科技创新 2030—"量子通信与量子计算机"重大项目负责人。',
    isGuest: true,
  },
]
