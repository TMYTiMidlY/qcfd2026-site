  ...
  },
{
    ...
    topic: '量超智多元融合先进计算平台及其应用',
    bio: '本源量子副总裁、量子软件中心高级总监，安徽省量子计算工程研究中心副主任，合肥量子计算与数据医学研究院副院长。主要从事量超智融合计算、量子操作系统、量子计算框架、量子应用与算法、量子云计算等技术领域的研究工作。主持/承担安徽省重大产业创新计划、国家重点研发计划、工信部 2025 未来产业创新任务揭榜挂帅等项目的研发工作。主要科研成果有量子操作系统本源司南、量子计算编程框架 QPanda、量子机器学习框架 VQNet、本源量子云平台等。',
    abstract:
