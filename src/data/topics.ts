 ...
 *  - 6 个方向（2026-05-12 用户重组，2026-05-13 新增 窦猛汉/QSIF 平台进入「硬件实现」方向）：
 *      1) 流体方程的量子算法与量子-经典混合算法
 *      2) 量子计算与人工智能/机器学习赋能流体力学（原 #2 + #6 合并）
 *      3) 流体量子模拟的硬件实现（含中性原子产业化 + QSIF 量超智融合平台）
 *      4) 非线性动力学的量子模拟
 *      5) 流体方程量子求解的具体实现
...
export const topics: Topic[] = [
  ...
  },
  {
    title: '流体量子模拟的硬件实现',
    description:
      '算法的优势最终要兑现到真实硬件上。本届报告关注中性原子量子计算的产业化路线（万比特规模化、双核架构、商业落地与海外出口）、超导路线下“量超智”异构融合计算平台（QSIF）的量子操作系统与 CPU/GPU/QPU 协同调度，并讨论 QLBM 等流体量子算法在硬件原生层面的电路深度优化与量子资源开销控制。',
    icon: 'cpu',
    keywords: ['中性原子', '汉原系列', 'QSIF 量超智融合', 'CPU/GPU/QPU 协同', '电路深度', 'ParaShift'],
    speakers: [
      {
        id: 'shi-zhiquan',
      ...
      {
        id: 'dou-menghan',
        note: '“量超智融合”计算平台 QSIF：量子操作系统 + 异构资源统一调度 + 量子-经典混合编程框架，实现 CPU/GPU/QPU 协同与跨架构通信。',
      },
      {
        id: 'niu-xiaodong',
