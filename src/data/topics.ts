 ...
 *  - 标题来自二轮通知 docx 第一段 + 公众号预告（合并去重）
 *  - description 由本届报告人 abstract 归纳，每条指向的支撑报告见 SOURCES.md
 *  - speakers 列出与该方向直接相关的报告人 id（一位报告人可出现在多个方向）
 */
export type Topic = {
  title: string
  description: string
...
export const topics: Topic[] = [
  {
    ...
    icon: 'sigma',
    speakers: ['liu-jinpeng', 'an-dong', 'niu-xiaodong', 'chen-zhaoyun'],
  },
  {
    ...
    icon: 'brain',
    speakers: ['tang-hui', 'xiao-dunhui', 'hu-heng'],
  },
  {
    title: '流体量子模拟的硬件实现',
    description:
    ...
    icon: 'cpu',
    speakers: ['shi-zhiquan', 'niu-xiaodong'],
  },
  {
    title: '非线性动力学的量子模拟',
    description:
    ...
    icon: 'waves',
    speakers: ['lu-zhen', 'an-dong', 'chen-zhaoyun'],
  },
  {
    title: '流体方程量子求解的具体实现',
    description:
    ...
    icon: 'atom',
    speakers: ['xiong-shiying', 'xu-liang', 'niu-xiaodong', 'wu-feng'],
  },
  {
    title: '量子机器学习赋能复杂流动',
    description:
    ...
    icon: 'network',
    speakers: ['xiao-dunhui', 'meng-zhaoyuan'],
  },
]
