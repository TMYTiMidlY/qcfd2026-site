...
export const news: NewsItem[] = [
  {
    ...
    excerpt:
      '每位注册参会者可获得"汉原 2 号"中性原子量子计算机 1 小时实机机时，由本届参展单位中科酷原科技（武汉）有限公司提供，用于会后试跑量子算法、复现报告中提及的 QCFD 工作。',
    body: [
      '每位注册参会者可获得"汉原 2 号"中性原子量子计算机 1 小时机时。',
      '"汉原 2 号"是本届参展单位中科酷原科技（武汉）有限公司研制的新一代中性原子量子计算机，可用于会后试跑各报告中提及的 QCFD 算法、复现实验或开展自有研究。',
