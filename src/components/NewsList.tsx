...
export function NewsList() {
  ...
  return (
    <section id="news" className="section-pad bg-section-alt">
      <div className="container-page">
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          {news.map((item) => {
            ...
            const baseClass =
              'group card-surface flex h-full flex-col overflow-hidden p-0 transition hover:-translate-y-1 hover:border-primary/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/60'
      ...
      <NewsDetailDialog item={active} onOpenChange={(o) => !o && setActive(null)} />
    </section>
  )
}
