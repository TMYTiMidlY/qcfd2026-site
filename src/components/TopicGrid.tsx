      ...
      <div className="container-page">
        <div className="max-w-2xl">
          ...
          <p className="mt-3 text-fg-soft">
            会议聚焦量子算法、量子-经典混合方法、硬件实现以及智能赋能等核心议题，沉淀流体力学与量子计算交叉研究的最新成果。
          </p>
        </div>
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {topics.map((t, idx) => {
            ...
            return (
              <div
                key={t.title}
                className="group relative card-surface overflow-hidden p-6 transition hover:-translate-y-1 hover:border-primary/40"
              >
